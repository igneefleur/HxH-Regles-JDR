...
FIX = {
    ...
    ("Cœur", 5): {
        "effet": "Le cœur se rompt et se vide d'un seul coup, l'organe déchiré ne pouvant plus assurer sa fonction. Le blessé subit un Saignement de −30 PV et la perte définitive de son cœur. Au début de son prochain tour, le blessé doit réussir un test de Résistance à la douleur Difficulté Impossible ou tomber Inconscient.",
